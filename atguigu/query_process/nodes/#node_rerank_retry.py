...
class NodeRerank(NodeBase):
    ...
    def cliff_detection(self, rerank_merge_docs):
        ...
        for k in range(use_min_topk, use_max_topk):
            prev_score = rerank_merge_docs[k - 1]["score"]
            next_score = rerank_merge_docs[k]["score"]
            abs_gap = abs(prev_score - next_score)
            rel_gap = abs_gap / (prev_score + 1e-6)  # 1e-6 防止除零
            if abs_gap > RERANK_GAP_ABS or rel_gap > RERANK_GAP_RATIO:
                return rerank_merge_docs[:k]
    ...
    def get_rerank_chunks(self, merge_docs, state):
        ...
        res = text_rerank(rewritten_query, texts, limit=len(merge_docs))
        for item in res:
            merge_docs[item.get("index")]["score"] = item["score"]
        rerank_merge_docs = sorted(merge_docs, key=lambda x: x["score"], reverse=True)
        return rerank_merge_docs

    def get_merge_docs(self, state):
        ...
        merge_docs = [
            {
                ...
                "title": doc.get("title", doc.get("item_name")),
                "url": doc.get("url"),
        ...
        "rrf_chunks": [
            {
                ...
                "id": 468273581540802500,
                "title": "## HAK 180 烫金机",
                "file_title": "hak180产品安全手册.pdf",
                "score": 1.7252958807788912,
                "source": "local"
            },
            {
                ...
                "item_name": "BrotherHAK180烫金机",
                "id": 468273581540802501,
                "title": "## HAK 180 烫金机",
                "file_title": "hak180产品安全手册.pdf",
                "score": 1.70508018232161,
                "source": "local"
            },
            {
                ...
                "item_name": "BrotherHAK180烫金机",
                "id": 468273581540802504,
                "title": "## 设备",
                "file_title": "hak180产品安全手册.pdf",
                "score": 1.6887192745057362,
                "source": "local"
            },
            {
                ...
                "item_name": "BrotherHAK180烫金机",
                "id": 468273581540802503,
                "title": "## 设备",
                "file_title": "hak180产品安全手册.pdf",
                "score": 1.6803802251815796,
                "source": "local"
            },
            {
                ...
                "item_name": "BrotherHAK180烫金机",
                "id": 468273581540802516,
                "title": "## 设备",
                "file_title": "hak180产品安全手册.pdf",
                "score": 1.6703449621403121,
                "source": "local"
            },
            {
                ...
                "item_name": "BrotherHAK180烫金机",
                "id": 468273581540802506,
                "title": "## 设备",
                "file_title": "hak180产品安全手册.pdf",
                "score": 1.648872316308625,
                "source": "local"
            },
            {
                "content": "![](images/677a08ee041965bbbdb6b483d6c17d5aaa36a26b6dc96870a2019f0307b8616f.jpg)  \nD01WD7001-00\n\nSCHN\n",
                "item_name": "BrotherHAK180烫金机",
                "id": 468273581540802499,
                "title": "无标题",
                "file_title": "hak180产品安全手册.pdf",
                "score": 1.5495928569648045,
                "source": "local"
            },
            {
                ...
                "item_name": "BrotherHAK180烫金机",
                "id": 468273581540802508,
                "title": "## 设备",
                "file_title": "hak180产品安全手册.pdf",
                "score": 1.5417340252822611,
                "source": "local"
            },
            {
                ...
                "item_name": "BrotherHAK180烫金机",
                "id": 468273581540802512,
                "title": "## 设备",
                "file_title": "hak180产品安全手册.pdf",
                "score": 1.4593790332631014,
                "source": "local"
            },
            {
                ...
                "item_name": "BrotherHAK180烫金机",
                "id": 468273581540802514,
                "title": "## 为设备选择一个安全的位置",
                "file_title": "hak180产品安全手册.pdf",
                "score": 1.422876791893935,
                "source": "local"
            }
        ],
        "web_search_docs": [
